...
import com.jdap.auction.application.base.BaseUserMBean;
...
public class UserMBean extends BaseUserMBean implements Serializable
{
	...
	/** Field description */
	@ManagedProperty ( value = "#{tableCategories}" )
	private TableCategoryMBean tableCategoryMBean;
...
/** Field description */
    ...
    public String createUser() throws AuctionServiceException
    {
    	...
    	tableCategoryMBean.queryCategories();
	...
	public String login() throws AuctionServiceException
	{
		...
		if (null != dbUser)
		{
			...
			tableCategoryMBean.queryCategories();
			//logger.info("****APPS, login****: Before tableItemMBean.queryItems()");
	...
	public TableCategoryMBean getTableCategoryMBean()
    {
    	return tableCategoryMBean;
    }


	public void setTableCategoryMBean(TableCategoryMBean tableCategoryMBean)
    {
    	this.tableCategoryMBean = tableCategoryMBean;
    }
