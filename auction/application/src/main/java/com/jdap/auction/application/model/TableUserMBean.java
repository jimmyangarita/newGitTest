...
import com.jdap.auction.application.util.SortFilterModel;
...
{
	private   List<UserMBean> users = new ArrayList<UserMBean>();
	...
	public String queryUsers() throws AuctionServiceException
	{
		...
		filterModel = new SortFilterModel(new ArrayDataModel(this.users.toArray()));
