...
//@XmlRootElement(name = "runtimeFaultMessage", namespace = "http://www.auction.com/api/adf/runtimeFault")
public class RuntimeFaultMessageType implements Serializable{

    @XmlElement(namespace = "http://www.auction.com/api/adf/runtimeFault", required = true)
    protected String code;
    @XmlElement(namespace = "http://www.auction.com/api/adf/runtimeFault", required = true)
    protected String summary;
    @XmlElement(namespace = "http://www.auction.com/api/adf/runtimeFault", required = true)
    protected RuntimeFaultMessageType.Detail detail;

    public RuntimeFaultMessageType(){};
     ...
     * @return
     *     possible object is
     *     {@link RuntimeFaultMessageType.Detail }
     *     
     */
    public RuntimeFaultMessageType.Detail getDetail() {
        return detail;
    }
     ...
     *     
     */
    public void setDetail(RuntimeFaultMessageType.Detail value) {
        this.detail = value;
    }
