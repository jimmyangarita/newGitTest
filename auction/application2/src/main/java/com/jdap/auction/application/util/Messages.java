...
package com.jdap.auction.application.util;
...
import com.jdap.auction.application.model.AddressMBean;

public class Messages
{

    /** Field description */
    public static Logger logger = Logger.getLogger( Messages.class.getName() );
	...
	//	logger.info("......Messages.getString(). Bunle1, Bundle2: "+bundle1 + " , " + bundle2 );
